    ...
    return (
        ...
        >
            ...
            <div className="split-panel group interactive">
                ...
                <div className="content-overlay absolute inset-0 z-10 flex flex-col justify-start md:justify-center px-6 md:px-20 text-white pt-24 md:pt-0">
                    <span className="text-brand-gold uppercase tracking-[0.3em] text-[10px] md:text-sm mb-2 md:mb-4 block">
                        Curated Essentials
                    </span>
                    <h2 className="font-serif text-2xl md:text-7xl mb-2 md:mb-4 whitespace-nowrap">Mountain Breeze</h2>
                    <p className="text-sm md:text-xl font-serif italic text-white/90 mb-3 md:mb-6">
            ...
            <div className="split-panel group interactive">
                ...
                <div className="content-overlay absolute inset-0 z-10 flex flex-col justify-center px-6 md:px-20 text-white pt-20 md:pt-0">
                    <span className="text-brand-gold uppercase tracking-[0.3em] text-[10px] md:text-sm mb-2 md:mb-4 block">
